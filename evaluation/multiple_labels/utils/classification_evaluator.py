...
class ClassificationEvaluator:
    ...
    def create_classification_confusion_table(self, actual_doc_labels_cx_df,
                                              ...
                                              threshold_val=0):
        actual_doc_labels_cx_plus_pred = pd.merge(actual_doc_labels_cx_df,
                                                  pred_doc_label_df[(pred_doc_label_df[pred_doc_score_column_name] > threshold_val)][
                                                      [pred_doc_id_column_name, pred_doc_label_column_name,
                                                       pred_doc_score_column_name]].drop_duplicates(),
                                                  how='left',
                                                  left_on=['doc_id', 'label_text'],
        ...
        cdf_long_plus_adj = pd.concat([cdf_long_plus[:-4], overall_metrics[-4:-2], overall_metrics_percent])
